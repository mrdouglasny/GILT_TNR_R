# MODULE: newton.jl
# USAGE: julia +1.10.4 --project=ekrgilttrnr ekrgilttrnr/scripts/newton.jl [options]
# INPUTS: None (generates initial tensor from parameters)
# OUTPUTS: ekrgilttrnr/newton/*.data (serialized fixed point tensors and eigenvalues)
# DESCRIPTION: Newton method to find 2D Ising fixed point tensor and extract critical exponents
# LATEX_DOC: ekrgilttrnr/docs/newton_method_guide.md
#
# This script applies Newton's method to find the fixed point tensor of the
# 2D Ising model at criticality, following Ebel, Kennedy, Rychkov (arXiv:2408.10312).
#
# BASED ON: EKR GILT-TNR (https://github.com/ebelnikola/GILT_TNR_R, arXiv:2408.10312)
# NEW IN THIS SCRIPT: Direct port of EKR Newton method with Julia/Python interop
#                     for GILT-TNR coarse-graining.
#
# RUNTIME: ~30 min at χ=30. Scales as O(χ⁶) for Jacobian construction.
#
# sections:
# - EXPERIMENT INIT
