# MODULE: plot_trajectory.jl
# USAGE: julia +1.10.4 --project=ekrgilttrnr ekrgilttrnr/scripts/plot_trajectory.jl [options]
# INPUTS: None (generates trajectory from initial tensor)
# OUTPUTS: stdout (trajectory data for plotting)
# DESCRIPTION: Generate RG trajectory data for visualization.
...
# NEW IN THIS SCRIPT: Adapted for our directory structure; outputs trajectory
#                     in format suitable for Python/Julia plotting.
#
# RUNTIME: ~5-10 min at χ=30, traj_len=30 steps.
