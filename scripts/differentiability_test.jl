# MODULE: differentiability_test.jl
# USAGE: julia +1.10.4 --project=ekrgilttrnr ekrgilttrnr/scripts/differentiability_test.jl [options]
# INPUTS: None (generates test data internally)
# OUTPUTS: stdout (differentiability test results)
# DESCRIPTION: Test differentiability of GILT-TNR map via finite differences.
...
# NEW IN THIS SCRIPT: Adapted for our directory structure; validates that RG map
#                     is sufficiently smooth for Newton method application.
#
# RUNTIME: ~5-10 min at χ=30. Tests convergence of finite difference derivatives.
#
# sections
